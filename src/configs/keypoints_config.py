...
DS_NUM_KEYPOINTS_INCL_FOOT=23

KEYPOINTS_DEF_INCL_FOOT={
 'nose'         :{"idx":0   ,"name":'nose'         ,"side":"C"   ,"ds_idxs":0    ,"mirror_name":None       },
 'sternum'      :{"idx":1   ,"name":'sternum'      ,"side":"C"   ,"ds_idxs":(5,6),"mirror_name":None       },
 'Rshoulder'    :{"idx":2   ,"name":'Rshoulder'    ,"side":"R"   ,"ds_idxs":6    ,"mirror_name":'Lshoulder'},
 'Relbow'       :{"idx":3   ,"name":'Relbow'       ,"side":"R"   ,"ds_idxs":8    ,"mirror_name":'Lelbow'   },
 ...
 'Leye'         :{"idx":16  ,"name":'Leye'         ,"side":"L"   ,"ds_idxs":1    ,"mirror_name":'Reye'     },
 'Lear'         :{"idx":17  ,"name":'Lear'         ,"side":"L"   ,"ds_idxs":3    ,"mirror_name":'Rear'     },
 'RbigToe'      :{"idx":18  ,"name":'RbigToe'      ,"side":"R"   ,"ds_idxs":20   ,"mirror_name":'LbigToe'  },
 'RsmallToe'    :{"idx":19  ,"name":'RsmallToe'    ,"side":"R"   ,"ds_idxs":21   ,"mirror_name":'LsmallToe'},
 'Rheel'        :{"idx":20  ,"name":'Rheel'        ,"side":"R"   ,"ds_idxs":22   ,"mirror_name":'Lheel'    },
 'LbigToe'      :{"idx":21  ,"name":'LbigToe'      ,"side":"L"   ,"ds_idxs":17   ,"mirror_name":'RbigToe'  },
 'LsmallToe'    :{"idx":22  ,"name":'LsmallToe'    ,"side":"L"   ,"ds_idxs":18   ,"mirror_name":'RsmallToe'},
 'Lheel'        :{"idx":23  ,"name":'Lheel'        ,"side":"L"   ,"ds_idxs":19   ,"mirror_name":'Rheel'    }
}

KEYPOINTS_DEF_INCL_FOOT = collections.OrderedDict(sorted(KEYPOINTS_DEF_INCL_FOOT.items(), key=lambda t: t[1]["idx"]))
...
"Lchick"        :{"idx":15 ,"kpts":('nose','Leye'),           "side":"L",  "name":"Lchick"    ,"other_side_idx":"Rchick"   },
"Ltemple"       :{"idx":16 ,"kpts":('Leye','Lear'),           "side":"L",  "name":"Ltemple"   ,"other_side_idx":"Rtemple"  },
"Rinstep"       :{"idx":17 ,"kpts":('Rankle','RbigToe'),      "side":"R",  "name":"Rinstep"   ,"other_side_idx":"Linstep"  },
"RforeFoot"     :{"idx":18 ,"kpts":('RbigToe','RsmallToe'),   "side":"R",  "name":"RforeToe"  ,"other_side_idx":"LforeToe" },
"RhindFoot"     :{"idx":19 ,"kpts":('Rankle','Rheel'),        "side":"R",  "name":"RhindToe"  ,"other_side_idx":"LhindToe" },
"Linstep"       :{"idx":20 ,"kpts":('Lankle','LbigToe'),      "side":"L",  "name":"Linstep"   ,"other_side_idx":"Rinstep"  },
"LforeFoot"     :{"idx":21 ,"kpts":('LbigToe','LsmallToe'),   "side":"L",  "name":"LforeToe"  ,"other_side_idx":"RforeToe" },
"LhindFoot"     :{"idx":22 ,"kpts":('Lankle','Lheel'),        "side":"L",  "name":"LhindToe"  ,"other_side_idx":"RhindToe" }
}
JOINTS_DEF_INCL_FOOT = collections.OrderedDict(sorted(JOINTS_DEF_INCL_FOOT.items(), key=lambda t: t[1]["idx"]))
